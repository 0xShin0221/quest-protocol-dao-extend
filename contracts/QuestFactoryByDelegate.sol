...
contract QuestFactoryByDelegate {
    address governer;

    bytes[] questDatas;

    constructor(IGovernor _governer) {
        _updateGoverner(_governer);
    }
    ...
    function createQustProposal(address[] memory _target, uint256[] memory _values, string memory _description) public {
    ...
    function _getQuestProposalBytes() internal {
    ...
    function _updateGoverner(IGovernor _governer) internal {
